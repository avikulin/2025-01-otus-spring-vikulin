...
public class CommentServiceImpl implements CommentsService {
    ...
    public Optional<Comment> findById(long id) {
        ...
        return this.commentRepository.findByIdWithCheck(id);
    }
    ...
    public List<Comment> findAllByBookId(long bookId) {
        ...
        return this.commentRepository.findAllByBookIdWithCheck(bookId);
    }
    ...
    public Comment update(long id, String commentText) {
        ...
        var comment = this.commentRepository.findByIdWithCheck(id).orElseThrow();
