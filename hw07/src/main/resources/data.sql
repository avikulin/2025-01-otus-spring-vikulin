...
INSERT INTO OTUS_HW_07.BOOKS(TITLE, YEAR_OF_PUBLISHED)
...
INSERT INTO OTUS_HW_07.COMMENTS(BOOK_ID, COMMENT_TEXT)
VALUES (1, 'Great book about SRE. Recommended to read.'), --1
       (1, 'It is realy helpful for interview preparation'), --1
       (2, 'Spring Framework rulez!'), --2
       (2, 'The most detailed book about Spring Framework.'), --2
       (3, 'Java know-how, that everybody have to read.'), --3
       (3, 'Helpful to write understandable & clean code.'), --3
       (4, 'Spring is the best!'), --4
       (5, 'The ageless classics from the Master'), --5
       (5, 'The university basis for system design'), --5
       (6, 'It really was interesting to read'), --6
       (7, 'The basing classics. Have to read.'), --7
       (8, 'It is all about microservices.... again!'), --8
       (9, 'The old good book from another Uncle Sam.'); --9

INSERT INTO OTUS_HW_07.AUTHORS(FULL_NAME)
...
INSERT INTO OTUS_HW_07.GENRES(NAME)
VALUES ('Java'), --1
       ('Algorithms'), --2
       ('Mathematics'), --3
       ('Spring'), --4
...
INSERT INTO OTUS_HW_07.LNK_BOOKS_AUTHORS(BOOK_ID, AUTHOR_ID)
VALUES (1, 1),
       (1, 2),
       (1, 3),
       (1, 4),
...
INSERT INTO OTUS_HW_07.LNK_BOOKS_GENRES(BOOK_ID, GENRE_ID)
VALUES (1, 5),
       (1, 6),
       (2, 1),
       (2, 4),
