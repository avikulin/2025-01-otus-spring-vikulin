...
public class LocalizedRuRuIoTestDataProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
        return Stream.of(
                ...
                Arguments.of("Char-to-char equality between input & output",
                                        ...
                                        new Object[]{"АаБбВв",0,1,2,3,3,2,1,0},
                                        "АаБбВв01233210"
                ),
                ...
                Arguments.of("Correct output of new-line",
                                        ...
                                        new Object[]{},
                                        System.lineSeparator().repeat(3) + "АаБбВв01233210" +
                ...
                Arguments.of("Correct output of new-line between other letters",
                                        ...
                                        new Object[]{},
                                        "АаБбВв"+System.lineSeparator().repeat(3)+"01233210"
                ),
