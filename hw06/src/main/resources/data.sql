...
INSERT INTO OTUS_HW_06.BOOKS(TITLE, YEAR_OF_PUBLISHED)
...
INSERT INTO OTUS_HW_06.COMMENTS(BOOK_ID, COMMENT_TEXT)
...
INSERT INTO OTUS_HW_06.AUTHORS(FULL_NAME)
...
INSERT INTO OTUS_HW_06.GENRES(NAME)
VALUES ('Java'), --1
       ('Algorithms'), --2
       ('Mathematics'), --3
       ('Spring'), --4
...
INSERT INTO OTUS_HW_06.LNK_BOOKS_AUTHORS(BOOK_ID, AUTHOR_ID)
VALUES (1, 1),
       (1, 2),
       (1, 3),
       (1, 4),
...
INSERT INTO OTUS_HW_06.LNK_BOOKS_GENRES(BOOK_ID, GENRE_ID)
VALUES (1, 5),
       (1, 6),
       (2, 1),
       (2, 4),
