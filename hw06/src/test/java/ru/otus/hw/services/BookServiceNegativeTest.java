...
@Import({BookServiceImpl.class, JpaAuthorRepository.class, JpaGenreRepository.class, JpaBookRepository.class,
        BookValidator.class, BookConverter.class, AuthorConverter.class, GenreConverter.class, CommentConverter.class,
        BookTestOperation.class, BookCheckerImpl.class, LoggedExceptionFactoryImpl.class})
class BookServiceNegativeTest extends ConfigurableByPropertiesTestBase {
    ...
    void throwsOnFindingByNotExistingId() {
        assertThrows(EntityNotFoundException.class, ()->bookService.findById(555L));
    }

    @Test
    @DisplayName("Throws on trying to find by impossible ID value")
    void throwsOnFindingByImpossibleId() {
        assertThrows(EntityValidationException.class, ()->bookService.findById(0L));
    }
